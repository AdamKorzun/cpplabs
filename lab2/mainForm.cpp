...
void __fastcall TForm3::SaveButtonClick(TObject *Sender)
{
	if (Form3->ComboBox->Text == "All") {
		Form3->MemoText->Lines->SaveToFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
		Form3->ComboBox->Clear();

        playerArray.SetLength(0);
		TStringList *stringList = new TStringList;
		stringList->LoadFromFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
...
void __fastcall TForm3::ShowButtonClick(TObject *Sender)
{
	if (Form3->ComboBox->Text == "All") {
		...
		Form3->MemoText->Lines->LoadFromFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
	}
	else {
		Form3->MemoText->Clear();
...
{
	//Form3->MemoText->Lines->LoadFromFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
	//Form3->ComboBox->Items->LoadFromFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
	TStringList *stringList = new TStringList;
	stringList->LoadFromFile("C:\\Users\\admin\\Desktop\\Ñ++\\2\ sem\\lab2\\file.txt");
	Form3->ComboBox->Items->Add("All");
	Player temp;
